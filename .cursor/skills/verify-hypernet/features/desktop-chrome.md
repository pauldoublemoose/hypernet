...
- Left pane has SEARCH plus collapsible EXPLORE, CREATE, and MANAGE.
- EXPLORE opens Global Spam Hell, Moonwalker, and Bot Roulette.
- CREATE expands to Coming soon.
